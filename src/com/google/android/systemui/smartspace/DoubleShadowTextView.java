...
public class DoubleShadowTextView extends TextView {
    ...
    public DoubleShadowTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        boolean z = ColorUtils.calculateLuminance(getCurrentTextColor()) > 0.5d;
        this.mDrawShadow = z;
    ...
    public void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.save();
        canvas.clipRect(getScrollX(), getExtendedPaddingTop() + getScrollY(), getScrollX() + getWidth(), getScrollY() + getHeight());
